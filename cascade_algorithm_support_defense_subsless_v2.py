...
def DSS_Python_Interface1(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, prot_sub_name):
...
# -------------------------------- Getting the contingency range -------------------------------
    contingencies = maptest_testing_trimmed_defense_v2.maptest14bus_test_system(comp_filename, start_range, contingency_range, prot_sub_name);
