# -*- coding: utf-8 -*-
"""
Created on Tue Apr 04 17:18:09 2017
...
# ---------------------Removing overloaded lines-------------------------------------
                ...
                if (stagecounter == stage_outage_vec_temp):
...
#    print "Number of Blackout cases = %d" %blackout_counter
    ...
    return (perct_load_loss, initial_loss, identify_initial_outage_state_vec, additional_outage, identify_additional_outage_state_vec);
#    ------------------------------------------------------------------------------------            
