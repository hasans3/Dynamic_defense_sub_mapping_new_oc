...
@author: saqibhasan
"""
def maptest14bus_test_system(comp_filename, start_range, contingency_range, max_load_loss_contingency, s_protect):
...
#    a_l = [];
    ...
    new_valueset = []
    valueset_new = []
    valueset = maptest_testing_trimmed_defense_v2.maptest14bus_test_system(comp_filename, start_range, contingency_range, s_protect);
