...
def greedy_hueristics(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, p_budget, prot_substation1):
    ...
    worst_case_subs = {};
    loadloss_gain = 0;
    max_load_loss_outage, max_loadloss = cascade_algorithm_support_defense_subsless_v2.DSS_Python_Interface1(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, prot_substation1);
#    print max_load_loss_outage
    ...
    for k in range(0, (p_budget-1)):
        new_outage_list = maptest_new_outage_list_support_defense_v2.maptest14bus_test_system(comp_filename, start_range, contingency_range, max_load_loss_outage, prot_substation1);
#        print new_outage_list
    ...
    worst_case_subs = obtain_subs_support_defense_v2.maptest14bus_test_system(comp_filename, start_range, contingency_range, worst_case_outage, prot_substation1)
