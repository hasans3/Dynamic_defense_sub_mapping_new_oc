...
def DSS_Python_Interface1(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, s_name_temp, prot_sub_name):
...
# -------------------------------- Getting the contingency range -------------------------------
    contingencies = maptest_testing_trimmed_defense.maptest14bus_test_system(comp_filename, start_range, contingency_range, s_name_temp, prot_sub_name);
