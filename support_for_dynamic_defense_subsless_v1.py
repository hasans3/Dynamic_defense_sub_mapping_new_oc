...
def worst_case_dynamic_attack(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, budget, sub_name1, protected_substation1):
...
#    import obtain_subs
    ...
    stage_vector = [1,2,3];
    static_greedy_worst_case_subs_dict, static_greedy_worst_case_outage, static_greedy_worst_case_load_loss = dynamic_attack_subs_less_support_for_defense.greedy_hueristics(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, budget, sub_name1, protected_substation1);
