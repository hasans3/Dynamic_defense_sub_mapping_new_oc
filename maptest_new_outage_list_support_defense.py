...
@author: saqibhasan
"""
def maptest14bus_test_system(comp_filename, start_range, contingency_range, max_load_loss_contingency, temp_s_pro, s_protect):
...
#    a_l = [];
    ...
    new_valueset = []
    valueset_new = []
    valueset = maptest_testing_trimmed_defense.maptest14bus_test_system(comp_filename, start_range, contingency_range, temp_s_pro, s_protect);
...
#        a_l.append(c)
#    print a_l
#maptest14bus_test_system("G:\saqib\open DSS\OpenDSS_Python_Interface\ieee_14_bus_data\component_data_subs.txt",0,1,[['Line.tl12', 'Line.tl34']]);
